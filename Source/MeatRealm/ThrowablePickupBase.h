...
#include "ThrowablePickupBase.generated.h"

/**
 * 
 */
UCLASS()
class MEATREALM_API AThrowablePickupBase : public APickupBase
{
	GENERATED_BODY()

public:
	AThrowablePickupBase()
	{
...
private:
	UPROPERTY(EditDefaultsOnly, Category = Pickup)
		TSubclassOf<class AThrowable> PickupClass;
};
